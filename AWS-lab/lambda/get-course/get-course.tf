...
resource "aws_iam_role_policy" "get-course-lambda-policy" {
  name = "${var.name}-lambda-policy"
  role = aws_iam_role.get-course-lambda-role.id
...
resource "aws_iam_role" "get-course-lambda-role" {
